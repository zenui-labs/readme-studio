...
<template>
  <nav
      class='absolute top-5 left-1/2 -translate-x-1/2 z-50 backdrop-blur-5xl flex items-center justify-between w-full max-w-[1200px] mx-auto py-2.5 rounded-full px-6'>
      ...
      <div class='relative'>
        ...
        >
          <ul v-if="isActiveDropdown"
            ...
            <li class='py-1 pl-1 pr-3.5 relative overflow-hidden group cursor-pointer font-medium text-[0.9rem] flex items-center gap-1 rounded-lg'>
                <span
                    class="absolute inset-0 bg-gradient-to-r from-blue-100 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-x-0 group-hover:scale-x-100 origin-left"
                ></span>
            ...
            <li class='py-2.5 px-3.5 relative group overflow-hidden cursor-pointer font-medium text-[0.9rem] flex items-center gap-2.5 rounded-lg'>
