  ...
  <div class="p-4 min-h-[400px] lg:min-h-[600px] max-h-[400px] lg:max-h-[800px] overflow-y-auto">
    <div class="grid grid-cols-2 gap-3">
      <button
          ...
          class="group w-full p-3 text-left bg-white dark:bg-gray-900 border border-gray-100 dark:border-darkBorder hover:bg-brandColor/10 hover:border-brandColor hover:shadow-md rounded-lg cursor-pointer transition-all duration-200 flex flex-col items-center gap-2.5"
      >
        <component
            :is="component.icon"
            :size="20"
